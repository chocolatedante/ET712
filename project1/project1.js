...
document.addEventListener("DOMContentLoaded", () => {
  const descriptionsByPage = {
    "project1colors.html": {
      ...
      "Blue": "Blue is the color of the ocean and blueberries.",
      "Green": "Green is the color of grass and frogs.",
      "Yellow": "Yellow is the color of bananas and sunshine.",
      "Orange": "Orange is the color of pumpkins and carrots.",
      "Purple": "Purple is the color of grapes and lilacs.",
      "Pink": "Pink is the color of cotton candy and flamingos.",
      "Brown": "Brown is the color of chocolate and bears.",
      "Black": "Black is the color of the night sky and bats.",
    ...
    "project1numbers.html": {
      ...
      "3": "Three is a triangle’s number of sides.",
    ...
    "project1animals.html": {
      "Dog": "Dogs are friendly and love to play fetch.",
      "Cat": "Cats are curious and like to nap.",
      ...
      "Duck": "Ducks waddle and love to swim.",
    ...
    "project1shapes.html": {
      ...
      "Star": "A star has five points and shines bright.",
      "Rectangle": "A rectangle has two long sides and two short sides.",
      "Oval": "An oval is like a stretched circle.",
      "Heart": "A heart shape means love.",
      "Diamond": "A diamond is shaped like a kite.",
